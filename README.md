...
[![Build Status](https://travis-ci.org/ManageIQ/manageiq-consumption.svg?branch=gaprindashvili)](https://travis-ci.org/ManageIQ/manageiq-consumption)
[![Coverage Status](https://coveralls.io/repos/github/ManageIQ/manageiq-consumption/badge.svg?branch=gaprindashvili)](https://coveralls.io/github/ManageIQ/manageiq-consumption?branch=gaprindashvili)
...
[![Build history for master branch](https://buildstats.info/travisci/chart/ManageIQ/manageiq-consumption?branch=gaprindashvili&buildCount=50)](https://travis-ci.org/ManageIQ/manageiq-consumption/branches)
