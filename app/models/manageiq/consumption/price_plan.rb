class ManageIQ::Consumption::PricePlan < ApplicationRecord
  ...
  def self.seed
    seed_data.each do |plan_attributes|
      ...
      next if ManageIQ::Consumption::PricePlan.find_by(:name => plan_attributes_name, :resource => plan_attributes_resource)
